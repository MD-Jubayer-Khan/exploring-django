...
class WithdrawMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        if bankRupt:
            messages.error(
            self.request,
            f'Bankrupt. You can not withdraw right now'
        )
...
class LoanRequestView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        if current_loan_count >= 3:
            return HttpResponse("You have exceeded the loan limits")
        messages.success(
            self.request,
...
class SendMoneyView(TransactionCreateMixin):
    ...
    def form_valid(self, form):
        ...
        try:
            ...
            send_transaction_email(self.request.user, amount, "Send Money", "transactions/send_money_email.html")
            send_transaction_email(receiver.user, amount, "Receive Money", "transactions/receive_money_email.html")
            return super().form_valid(form)
